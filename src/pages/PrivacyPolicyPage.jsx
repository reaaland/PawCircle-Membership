      ...
      <div className="container">
        <div className="row row__narrow">
          ...
          <ul className="legal__list">
            ...
            <li>Email address</li>
            <li>Phone number</li>
            <li>Membership profile information</li>
          ...
          <p>
            Information included in member profiles may be visible to other
            members as part of the operation of the platform.
          </p>
          ...
          <p>
            ...
            the platform, including payment processors, website hosting
            providers, and other service providers supporting platform
            operations.
          </p>

          <h2>Data Security</h2>
          <p>
            We use reasonable measures to protect personal information. However,
            no method of electronic transmission or storage can be guaranteed to
          ...
          <p>
            These technologies help us operate the platform, maintain security,
            remember user preferences, and improve the user experience.
          </p>
